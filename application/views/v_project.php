            ...
            <div class="col-md-12">
              ...
              <div class="card card-white">
                <div class="card-header">
                  <a href="<?php echo base_url("project/add"); ?>" class="btn btn-primary btn-sm"><i
                    ...
                    <tbody>
                      ...
                      <?php foreach ($project as $row): ?>
                        <tr>
                          ...
                          <td width="10%">
                            <a href="<?php echo base_url("project/edit/" . $row->id_project); ?>"
                              class="btn btn-success btn-sm"><i class="fa fa-edit"></i></i></a>
                            <a href="<?php echo base_url("project/delete/" . $row->id_project); ?>"
                              class="btn btn-danger btn-sm" onclick="confirm('Yakin data dihapus!'); "><i class="fa fa-trash"></i></i></a>
                          </td>
                        </tr>
                        <?php $no++; ?>
                      <?php endforeach; ?>
