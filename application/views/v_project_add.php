          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="<?php echo base_url("project/insert"); ?>" method="post">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="gambar_project">Gambar Project</label>
                      <input type="text" class="form-control" name="gambar_project" placeholder="Masukkan Nama Gambar Project">
                    </div>
                    <div class="form-group">
                      <label for="deskripsi_project">Deskripsi Project</label>
                      <input type="text" class="form-control" name="deskripsi_project" placeholder="Masukkan Tahun Deskripsi Project">
                    </div>
                  </div>
                  <!-- /.card-body -->
