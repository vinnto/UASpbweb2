            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Edit Organisasi</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="<?php echo base_url("organisasi/update"); ?>" method="post">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="nama_organisasi">Nama Organisasi</label>
                      <input type="text" class="form-control" name="nama_organisasi"
                        placeholder="Masukkan Nama Organisasi" value="<?php echo $data_organisasi->nama_organisasi; ?>">
                    </div>
                    <div class="form-group">
                      <label for="tahun_organisasi">Tahun Organisasi</label>
                      <input type="text" class="form-control" name="tahun_organisasi"
                        placeholder="Masukkan Tahun Organisasi"
                        value="<?php echo $data_organisasi->tahun_organisasi; ?>">
                    </div>
                    <div class="form-group">
                      <label for="jabatan_organisasi">Jabatan Organisasi</label>
                      <input type="text" class="form-control" name="jabatan_organisasi"
                        placeholder="Masukkan Jabatan Organisasi"
                        value="<?php echo $data_organisasi->jabatan_organisasi; ?>">
                    </div>
                  </div>
                  <!-- /.card-body -->
                  <div class="card-footer">
                    <input type="hidden" name="id_organisasi"
                      value="<?php echo $data_organisasi->id_organisasi; ?>">
